...
export const projects: Project[] = [
  {
    ...
    title: "Wilde Snacks",
    subtitle:
      "High-Protein Snack Brand E-Commerce & Interactive Landing Experience",
    category: "E-Commerce Experience",
    description:
      "A high-impact, cyberpunk-inspired e-commerce landing experience built for Wilde Protein Chips with kinetic typography, flavor universes, interactive nutrition calculators, and crunch comparisons.",
    longDescription:
      "Wilde Snacks is an ultra-modern, high-octane brand showcase and e-commerce experience engineered for protein-packed chicken chicken-breast chips. The landing page features a cyberpunk dark aesthetic with electric green neon lighting, 3D flavor showcase universes (Zesty Jalapeño, Buffalo Style, Himalayan Pink Salt), an interactive Snack Finder quiz, nutrition comparison graphs, an infinite snack media wall, and kinetic scroll animations that elevate digital direct-to-consumer food brand experiences.",
    stack: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    live: "",
    github: "",
    image: "/projects/wilde/wilde(1).png",
    gallery: [
      "/projects/wilde/wilde(1).png",
      "/projects/wilde/wilde(2).png",
      "/projects/wilde/wilde(3).png",
      "/projects/wilde/wilde(4).png",
      "/projects/wilde/wilde(5).png",
      "/projects/wilde/wilde(6).png",
      "/projects/wilde/wilde(7).png",
      "/projects/wilde/wilde(8).png",
      "/projects/wilde/wilde(9).png",
      "/projects/wilde/wilde(10).png",
      "/projects/wilde/wilde(11).png",
      "/projects/wilde/wilde(12).png",
      "/projects/wilde/wilde(13).png",
      "/projects/wilde/wilde(14).png",
      "/projects/wilde/wilde(15).png",
      "/projects/wilde/wilde(16).png",
      "/projects/wilde/wilde(17).png",
      "/projects/wilde/wilde(18).png",
      "/projects/wilde/wilde(19).png",
      "/projects/wilde/wilde(20).png",
      "/projects/wilde/wilde(21).png",
      "/projects/wilde/wilde(22).png",
      "/projects/wilde/wilde(23).png",
      "/projects/wilde/wilde(24).png",
    ],
    featured: true,
    ...
    features: [
      "High-energy kinetic typography hero ('POP IT. LIKE IT'S HOT.')",
      "3D-inspired flavor universe showcase with particle blast visuals",
      "Interactive 'Find Your Signature Crunch' quiz recommendation flow",
      "Interactive 'Crunch Comparison' nutritional breakdown vs traditional chips",
      "Dynamic infinite snack wall with interactive product cards",
      "Interactive ingredient explosion layers and breakdown tabs",
      "Floating testimonial carousel with verified customer ratings",
      "Dark-mode cyberpunk glassmorphism with electric neon accents",
    ],
    advancedFeatures: [
      "Multi-flavor universe explorer with interactive macro stats (Protein, Carbs, Calories)",
      "Interactive quiz state machine with real-time flavor matching algorithm",
      "Smooth scroll-driven kinetic typography and parallax chip reveals",
      "Glassmorphic nutrition experience comparison tables with animated bar stats",
      "Micro-interactions on CTA buttons ('READY TO GET WILDE?') with glow trails",
      "High-performance responsive layout optimized for mobile and desktop",
    ],
    challenges: [
      "Orchestrating high-density visual particle effects without sacrificing 60fps scroll performance",
      "Designing responsive cyberpunk typography hierarchy across all mobile viewports",
      "Creating seamless flavor transitions and interactive nutrition comparison tables",
    ],
    learnings: [
      "Mastered dark cyberpunk design systems with high-contrast neon accents",
      "Implemented stateful interactive quiz flows for personalized product recommendations",
      "Enhanced kinetic typography and scroll-driven brand storytelling techniques",
    ],
    architecture: {
      frontend: "Next.js 15 (App Router) + React",
      styling: "Tailwind CSS + Custom CSS Variables",
      deployment: "Vercel Edge Network",
      backend: "Headless E-Commerce Architecture",
    },
    seo: {
      metaTitle: "Wilde Snacks - High Protein Chicken Breast Chips Experience",
      metaDescription:
        "High-protein, low-carb chip revolution. Explore explosive flavors, interactive crunch comparisons, and signature snack finder.",
      keywords: [
        "Wilde Snacks",
        "Protein Chips",
    ...
    highlights: [
      {
        ...
        description:
          "Interactive 3D-styled flavor carousel showcasing nutritional macros, ingredients, and flavor profiles.",
      },
      {
        title: "Signature Crunch Quiz",
        description:
          "Dynamic interactive snack finder recommending customized chip varieties based on lifestyle and crunch goals.",
      },
      {
        title: "Nutritional Comparison",
        description:
          "Animated head-to-head comparison chart highlighting 10g protein and low-carb advantages over traditional chips.",
      },
    ],
    testimonials: [
      {
        name: "Verified Snack Enthusiast",
        feedback:
          "10g of protein in a chip that tastes this explosive? Absolute game changer for clean snacking.",
      },
    ],
    futureImprovements: [
      "Direct Shopify / Headless cart and checkout integration",
      "3D Spline bag rotation viewer with 360-degree pinch-to-zoom",
      "Subscription box customizer with live macro totals",
    ],
    media: [
      {
        type: "video",
        src: "/projects/wilde/wilde.mp4",
        alt: "Wilde Snacks Interactive Walkthrough",
        caption:
          "High-protein snack brand interactive landing & e-commerce showcase",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(1).png",
        alt: "Wilde Snacks Hero View",
        caption: "POP IT. LIKE IT'S HOT - Kinetic hero experience",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(2).png",
        alt: "A Chip That Shouldn't Exist",
        caption: "High-protein chicken breast chip innovation",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(3).png",
        alt: "Ingredient Explosion Showcase",
        caption: "Interactive layered ingredient breakdown",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(4).png",
        alt: "Flavor Universe Zesty Jalapeño",
        caption: "3D-inspired flavor universe & macro breakdown",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(5).png",
        alt: "Infinite Snack Wall",
        caption: "Dynamic product catalog and lifestyle showcase",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(6).png",
        alt: "Brand Story & Heritage",
        caption: "Born In A Home Kitchen - Founder journey",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(7).png",
        alt: "Crunch Comparison Breakdown",
        caption: "Nutritional comparison chart vs traditional chips",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(8).png",
        alt: "Floating Customer Testimonials",
        caption: "Verified customer reviews & social proof",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(9).png",
        alt: "Signature Snack Collection",
        caption: "Full variety pack flavor lineup",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(10).png",
        alt: "Nutrition Experience Module",
        caption: "Complete macronutrient profile breakdown",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(11).png",
        alt: "Find Your Signature Crunch Quiz",
        caption: "Interactive product recommendation quiz",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(12).png",
        alt: "Ready to Get Wilde CTA",
        caption: "High-conversion CTA & footer experience",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(13).png",
        alt: "Product Detail View 1",
        caption: "Crispy chicken chips packaging shot",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(14).png",
        alt: "Product Detail View 2",
        caption: "Buffalo style flavor details",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(15).png",
        alt: "Product Detail View 3",
        caption: "Himalayan pink salt flavor profile",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(16).png",
        alt: "Mobile Responsive Layout 1",
        caption: "Mobile view: Hero and flavor explorer",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(17).png",
        alt: "Mobile Responsive Layout 2",
        caption: "Mobile view: Interactive ingredient layer",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(18).png",
        alt: "Mobile Responsive Layout 3",
        caption: "Mobile view: Infinite snack wall grid",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(19).png",
        alt: "Mobile Responsive Layout 4",
        caption: "Mobile view: Nutrition comparison tables",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(20).png",
        alt: "Mobile Responsive Layout 5",
        caption: "Mobile view: Signature crunch quiz flow",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(21).png",
        alt: "UI Component System",
        caption: "Neon typography & cyber button variants",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(22).png",
        alt: "Dark Theme Aesthetic",
        caption: "Cyberpunk dark mode with electric green glow",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(23).png",
        alt: "Cart & Checkout Flow",
        caption: "Interactive shopping cart drawer preview",
      },
      {
        type: "image",
        src: "/projects/wilde/wilde(24).png",
        alt: "Complete Platform Architecture",
        caption: "Full landing page overview and ecosystem",
      },
    ],
  },
  {
